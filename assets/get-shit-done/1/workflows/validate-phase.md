...
<required_reading>
@/Users/mertsidim/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
```
Task(
  prompt="Read /Users/mertsidim/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mertsidim/.claude/get-shit-done/templates/VALIDATION.md`
