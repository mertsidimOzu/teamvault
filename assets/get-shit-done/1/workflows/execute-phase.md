...
2. **Spawn executor agents:**
   ...
   Task(
     ...
     prompt="
       ...
       @/Users/mertsidim/.claude/get-shit-done/references/tdd.md
       </execution_context>
...
Read and follow `/Users/mertsidim/.claude/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
